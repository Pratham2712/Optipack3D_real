    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='home.company')),
        ...
        migrations.CreateModel(
            name='SKU',
            fields=[
                ('sku_code', models.BigIntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ordersku', to='home.company')),
        ...
        migrations.AddField(
            model_name='sku',
            name='user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='SKU', to='home.users'),
        ),
        migrations.AddField(
            model_name='ordersku',
            name='user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ordersku', to='home.users'),
        ),
        migrations.AddField(
            model_name='order',
            name='user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='home.users'),
        ),
        migrations.CreateModel(
            name='LoadPlan',
            fields=[
                ...
                ('company', models.ForeignKey(default='0000', on_delete=django.db.models.deletion.CASCADE, related_name='load_plan', to='home.company')),
        ...
        migrations.CreateModel(
            name='LoadPlanContainer',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.PositiveIntegerField(default=1)),
                ('company', models.ForeignKey(default='0000', on_delete=django.db.models.deletion.CASCADE, to='home.company')),
                ('container', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.container')),
                ('load_plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.loadplan')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='LoadPlanAssignment',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('assigned_at', models.DateTimeField(auto_now_add=True)),
                ('load_plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assignments', to='home.loadplan')),
                ('assigned_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assigned_load_plans', to='home.users')),
                ('assignee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='load_plan_assignments_made', to='home.users')),
            ],
            options={
